...
<body>
  ...
  <header id="header" class="fixed-top  header-transparent ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.html">WIKBOOK</a></h1>
     </div>
  ...
  <section id="hero" class="d-flex align-items-center">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6  align-items-stretch order-1 order-lg-2 hero-img" data-aos="fade-up">
          <img src="{{asset('assets/img/read.jpg')}}" class="img-fluid" alt="">
        </div>
      </div>
    </div>
